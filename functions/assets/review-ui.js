...
function buildJs() {
  ...
  return [
    ...
    "  var clientImageFile = $('clientImageFile');",
    "",
...
"            mobileOverride;",
    ...
    "      }",
    "",
    "      /* --- Client file upload (fills clientImageUrl) --- */",
    "      if(clientImageFile){",
    ...
    "            showToast('Image too large (max 2 MB). Please resize first.', 'error');",
    "            return;",
    "          }",
    ...
    "              showToast('Upload failed: unexpected format.', 'error');",
    "              return;",
    "            }",
    "            if(clientImageUrl) clientImageUrl.value = dataUrl;",
    "            showClientPreview(dataUrl);",
    "            showToast('Image loaded. Click Save image to store it.', 'success');",
    "          };",
