...
"            mobileOverride;",
    ...
    "",
"      // Lock UI only for terminal (post-decision) states",
"      // Everything else should remain interactive (edit/save/accept).",
"      var terminal = {",
"        'APPROVED':1, 'ACCEPTED':1, 'PUBLISHED':1, 'EXPIRED':1, 'SUPERSEDED':1",
"      };",
"      var isInteractive = !terminal[status];",
"      if(!isInteractive){",
"        disableAll();",
...
"      }",
    ...
    "          isInteractive{ showToast('Link not active ('+status+')', 'error'); return; }",
    "          editing = !editing;",
    "          setEditing(editing);",
...
"      }",
    ...
    "          isInteractive{ showToast('Link not active ('+status+')', 'error'); showModal(false); return; }",
